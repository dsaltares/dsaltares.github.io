...
![](/img/tiny-backup/tiny-backup1.webp)
...
<ImageGallery
  images={[
    '/img/tinybackup/gallery/tinybackup.webp',
    '/img/tinybackup/gallery/tinybackup-save.webp',
    '/img/tinybackup/gallery/tinybackup-restore.webp',
  ]}
/>
