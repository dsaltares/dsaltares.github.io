...
![htc-desire-hd.png](/img/wp/htc-desire-hd.webp)
...
2.  Entra en modo recovery, lo conseguirás pulsando el botón _"bajar volumen"_ mientras enciendes el terminal.
3.  Selecciona la opción _"factory reset"_. Para desplazarte por el menú puedes emplear las teclas de volumen, cuando quieras elegir una opción presiona ligeramente el botón de encendido.
