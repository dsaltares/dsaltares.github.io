...
- _t_: abre la lista de temas disponibles
- _f_: cambia entre modo reducido y completo. En el modo reducido no aparecen todos los kernels antiguos.
- _c_: abre una terminal.
