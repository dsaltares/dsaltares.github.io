...
keywords:
  [
    'local development',
    'nextauth.js local development',
    'mailhog testing SMTP server',
    'docker SMTP server',
  ]
---

![NextAuth.js logo](/img/nextjs/nextauth.webp)
...
![NextAuth.js login screen](/img/nextjs/nextauth-login.webp)

Now you can open `http://localhost:8025/` and see the email with the magic link.

![MailHog inbox](/img/nextjs/mailhog.webp)
