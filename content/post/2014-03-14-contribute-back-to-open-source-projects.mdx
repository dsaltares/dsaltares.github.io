---
id: 2915
title: Contribute back to open source projects
date: 2014-03-14T16:42:15+00:00
author: David Saltares
layout: post
guid: http://siondream.com/blog/?p=2915
url: /computing/contribute-back-to-open-source-projects/
dsq_thread_id:
  - 2430694151
categories:
  - Computing
...
Developers love [Libgdx](https://github.com/libgdx/libgdx), it's an extremely efficient, easy to use, open source, feature rich, cross platform framework. It has a huge community, and a very active repository. What's not to love? The fact that [1.40% apps on AppBrain use Libgdx](http://www.appbrain.com/stats/libraries/details/libgdx/libgdx) backs that up.

![libgdx-appbrain-stats.png](/img/wp/libgdx-appbrain-stats.webp)
...
Some [pull requests](https://github.com/libgdx/libgdx/pull/575) contain interesting discussions about software design and programming.
...
![libgdx-pull-request.png](/img/wp/libgdx-pull-request.webp)

[Everyone makes mistakes](https://github.com/libgdx/libgdx/pull/1335), and when that happens, people will politely point it out, giving the contributor a chance to fix it and resubmit. The community is understanding and I haven't seen any attempts to bring shame to anyone.

This is not a League of Legends game.

Unfortunately, [this is not the case for every project](/computing/dont-be-a-dick-with-the-community/). We're lucky Libgdx is full of love.
...
In order to start contributing back to Libgdx, it's advisable to read the _[Contributing](https://github.com/libgdx/libgdx/wiki/Contributing)_ wiki page. Later on you should do the following.

1. Clone the repository
2. Check the [issues and feature requests](https://github.com/libgdx/libgdx/issues?state=open) section
3. Work on it
4. Send a [pull request](https://github.com/libgdx/libgdx/pulls)
5. Rinse and repeat

When in doubt, you can always ask in the [forums](http://www.badlogicgames.com/forum/) or discuss in the #libgdx IRC channel at `irc.freenode.net`.
