...
![particulas-iberogre.png](/img/wp/particulas-iberogre.webp)
...
- Estructura de un sistema de partículas: propiedades, _Emitters_ y _Afectors_.
- Creación y gestión de sistemas de partículas.
- La herramienta _Particle Editor_.
