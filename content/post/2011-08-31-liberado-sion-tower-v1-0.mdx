---
id: 1726
title: Liberado Sion Tower v1.0
date: 2011-08-31T16:49:24+00:00
author: David Saltares
layout: post
guid: http://siondream.com/blog/?p=1726
url: /games/liberado-sion-tower-v1-0/
views:
  - 2427
dsq_thread_id:
  - 1852024321
...
Acabo de subir a la forja el paquete con la **versión 1.0 de Sion Tower** tras la [demo técnica](/proyectos/pfc/sion-tower/sion-tower-0-1-demo-tecnica/) de hace algunos meses. Esta será la versión que presente la próxima semana ante el tribunal de Proyecto fin de Carrera, ¡deseadme suerte! Entrad en el artículo para los **enlaces de descarga**.
...
![siontower-juego.jpg](/img/wp/siontower-juego.webp)

### Descarga

El código fuente de Sion Tower está sujeto a una licencia [GPL v3](http://gplv3.fsf.org/) mientras que los recursos multimedia (modelos, texturas, música, scripts y efectos) están liberados bajo [Creative Commons 3.0 by-nc-sa](http://creativecommons.org/licenses/by-nc-sa/3.0/).

- [Sion Tower v1.0 código fuente y GNU/Linux](http://forja.rediris.es/frs/download.php/2393/siontower-1.0-src.tar.gz)
- [Sion Tower v1.0 Windows](http://forja.rediris.es/frs/download.php/2394/siontower-1.0-win.zip)
