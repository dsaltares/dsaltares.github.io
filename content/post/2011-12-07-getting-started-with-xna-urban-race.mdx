...
![urbanrace-ingame.jpg](/img/urban-race/urbanrace-5.webp)
...
![urbanrace-blender.jpg](/img/wp/urbanrace-blender.webp)
...
- **Blender**: open source 3D modelling, texturing and animation tool. I've
  used it as my level editor as well exporting to the [Dotscene xml
  format](http://www.ogre3d.org/tikiwiki/DotScene).
- **The Gimp**: open source 2D graphic tool that I've used for texturing my
  models.
- **Inkscape**: open source 2D vector tool which I've used to design my
  track's pieces since they needed to be geometrically exact so they could fit
  together.
